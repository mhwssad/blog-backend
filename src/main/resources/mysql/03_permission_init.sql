...
VALUES
(1000, 0, '0', '系统管理', 'C', 'System', '/system', 'Layout', NULL, 1, 0, 1, 1, 'system', NULL, NOW(), NOW(), NULL);

-- 用户管理
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1100, 1000, '0,1000', '用户管理', 'M', 'SysUser', 'users', 'system/user/index', NULL, 0, 1, 1, 1, 'user', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1200, 1000, '0,1000', '角色管理', 'M', 'SysRole', 'roles', 'system/role/index', NULL, 0, 1, 1, 2, 'peoples', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1300, 1000, '0,1000', '菜单管理', 'M', 'SysMenu', 'menus', 'system/menu/index', NULL, 0, 1, 1, 3, 'tree-table', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1400, 1000, '0,1000', '参数配置', 'M', 'SysConfig', 'configs', 'system/config/index', NULL, 0, 1, 1, 4, 'edit', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1500, 1000, '0,1000', '通知管理', 'M', 'SysNotice', 'notices', 'system/notice/index', NULL, 0, 1, 1, 5, 'message', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1600, 1000, '0,1000', '日志管理', 'M', 'SysLog', 'logs', 'system/log/index', NULL, 0, 1, 1, 6, 'log', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1700, 0, '0', '内容管理', 'C', 'Content', '/content', 'Layout', NULL, 1, 0, 1, 2, 'document', '/content/articles', NOW(), NOW(), NULL);

-- 文章管理
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1710, 1700, '0,1700', '文章管理', 'M', 'ContentArticle', 'articles', 'content/article/index', NULL, 0, 1, 1, 1, 'edit-pen', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1720, 1700, '0,1700', '分类管理', 'M', 'ContentCategory', 'categories', 'content/category/index', NULL, 0, 1, 1, 2, 'folder-opened', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1730, 1700, '0,1700', '标签管理', 'M', 'ContentTag', 'tags', 'content/tag/index', NULL, 0, 1, 1, 3, 'price-tag', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1740, 1700, '0,1700', '评论管理', 'M', 'ContentComment', 'comments', 'content/comment/index', NULL, 0, 1, 1, 4, 'chat-dot-round', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1750, 1700, '0,1700', '收藏管理', 'M', 'ContentCollection', 'collections', 'content/collection/index', NULL, 0, 1, 1, 5, 'star', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1760, 1700, '0,1700', '互动管理', 'M', 'ContentInteraction', 'interactions', 'content/interaction/index', NULL, 0, 1, 1, 6, 'pointer', NULL, NOW(), NOW(), NULL),
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `tree_path`, `name`, `type`, `route_name`, `route_path`, `component`, `perm`, `always_show`, `keep_alive`, `visible`, `sort`, `icon`, `redirect`, `create_time`, `update_time`, `params`)
VALUES
(1770, 1700, '0,1700', '足迹管理', 'M', 'ContentFootprint', 'footprints', 'content/footprint/index', NULL, 0, 1, 1, 7, 'clock', NULL, NOW(), NOW(), NULL),
