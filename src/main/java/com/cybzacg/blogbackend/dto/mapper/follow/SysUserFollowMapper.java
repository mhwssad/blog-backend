package com.cybzacg.blogbackend.dto.mapper.follow;
...
public interface SysUserFollowMapper extends BaseMapper<SysUserFollow> {
    Long countFollowPage(
        @Param("userId") Long userId,
        @Param("specialOnly") Boolean specialOnly
    );

    List<FollowRelationUserItem> selectFollowPage(
        @Param("userId") Long userId,
        @Param("specialOnly") Boolean specialOnly,
    ...
    List<FollowRelationUserItem> selectFanPage(
        @Param("userId") Long userId,
        @Param("offset") Long offset,
        @Param("size") Long size
    );
    ...
    List<PublicFollowUserItem> selectPublicFollowPage(
        @Param("userId") Long userId,
        @Param("offset") Long offset,
        @Param("size") Long size
    );
    ...
    List<PublicFollowUserItem> selectPublicFanPage(
        @Param("userId") Long userId,
        @Param("offset") Long offset,
        @Param("size") Long size
    );
    ...
    List<FollowAdminRelationItem> selectAdminRelationPage(
        @Param("query") FollowAdminPageQuery query,
        @Param("offset") Long offset,
        @Param("size") Long size
    );

    Long countCleanableRelations(
        @Param("cleanInactive") boolean cleanInactive,
        @Param("cleanDeletedUsers") boolean cleanDeletedUsers,
        @Param("cleanDisabledUsers") boolean cleanDisabledUsers
    );

    int deleteCleanableRelations(
        @Param("cleanInactive") boolean cleanInactive,
        @Param("cleanDeletedUsers") boolean cleanDeletedUsers,
        @Param("cleanDisabledUsers") boolean cleanDisabledUsers
    );
