...
public interface DashboardMetricsMapper {
    ...
    Long countForumReplies(
        @Param("startTime") LocalDateTime startTime,
        @Param("endTime") LocalDateTime endTime
    );

    List<DashboardHotSectionVO> listHotSections(
        @Param("startTime") LocalDateTime startTime,
        @Param("endTime") LocalDateTime endTime,
    ...
    Long countAgentTasks(
        @Param("startTime") LocalDateTime startTime,
        @Param("endTime") LocalDateTime endTime,
        @Param("status") Integer status
    );

    BigDecimal averageReportHandleDurationMinutes(
        @Param("startTime") LocalDateTime startTime,
        @Param("endTime") LocalDateTime endTime
    );

    List<DashboardPunishmentDistributionVO> listPunishmentDistributions(
        @Param("startTime") LocalDateTime startTime,
        @Param("endTime") LocalDateTime endTime
    );
}
