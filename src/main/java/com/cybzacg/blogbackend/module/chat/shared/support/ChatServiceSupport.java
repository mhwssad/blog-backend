...
public class ChatServiceSupport {
    ...
    public ConversationAccessContext requireGroupAccess(Long userId, Long conversationId) {
    ...
    public ConversationAccessContext requireGroupOwner(Long userId, Long conversationId) {
    ...
    public ConversationAccessContext requireGroupManager(Long userId, Long conversationId) {
        ConversationAccessContext context = requireGroupAccess(userId, conversationId);
    ...
    public void upsertConversationMembership(ChatConversation conversation,
                                             Long memberUserId,
                                             String memberRole,
                                             String joinSource,
    ...
    public Map<Long, List<ChatConversationMember>> listActiveMembersByConversationIds(Collection<Long> conversationIds) {
    ...
    public ChatConversationMember requireActiveGroupMember(Long conversationId, Long memberUserId) {
    ...
    public void validateManagerCanOperateMember(ChatConversationMember manager, ChatConversationMember targetMember) {
    ...
    public List<Long> normalizeMemberIds(Collection<Long> memberUserIds, Long excludeUserId) {
    ...
    public int countAdditionalMembers(Long conversationId, Collection<Long> memberUserIds) {
    ...
    public void ensureConversationMemberLimitAllows(ChatConversation conversation, int additionalCount) {
    ...
    public void ensureMemberLimitAllows(Integer memberLimit, int expectedCount, String message) {
        if (memberLimit == null || memberLimit <= 0) {
            return;
        }
    ...
    public SysUser requireActiveUser(Long userId, boolean allowSelf) {
        ...
        Long currentUserId = com.cybzacg.blogbackend.utils.SecurityUtils.getUserId();
    ...
    public void requireActiveUsers(Collection<Long> userIds, boolean allowSelf) {
        if (userIds == null) {
            return;
        }
    ...
    public ChatMessageReadCursor getOrCreateCursor(Long conversationId, Long userId, Long referenceMessageId, LocalDateTime referenceTime) {
    ...
    public void advanceCursorDeliveredState(Long conversationId, Long userId, Long messageId, LocalDateTime deliveredAt) {
        if (messageId == null) {
            return;
        }
    ...
    public void advanceMemberDeliveredState(ChatConversationMember member, Long messageId, LocalDateTime deliveredAt) {
    ...
    public void updateMemberReadState(ChatConversationMember member, Long messageId, LocalDateTime readAt) {
    ...
    public ChatMessageHistoryItem requireVisibleMessage(Long userId, Long conversationId, Long messageId) {
    ...
    public ChatMessage requireVisibleMessageEntity(Long userId, Long messageId) {
    ...
    public ChatMessageHistoryItem findExistingMessage(Long userId, String clientMessageId, Long conversationId) {
    ...
    public List<ChatConversationVO> buildConversationRecords(Long userId, List<ChatConversationListItem> items) {
    ...
    public ChatConversationVO buildConversationVO(Long userId,
    ...
    public List<ChatMemberVO> buildMemberRecords(List<ChatConversationMember> members) {
        if (members.isEmpty()) {
            return List.of();
        }
    ...
    public ChatMessageVO buildMessageVO(Long currentUserId, ChatMessageHistoryItem item, Map<Long, SysUser> userMap) {
    ...
    public ChatMessageVO buildMessageVO(Long currentUserId,
    ...
    public ChatReplyMessageVO buildReplySnapshot(ChatMessageHistoryItem item, Map<Long, SysUser> userMap) {
    ...
    public ChatReplyMessageVO resolveReplySnapshot(ChatMessageHistoryItem item,
                                                   String payloadJson,
                                                   Map<Long, ChatReplyMessageVO> replySnapshots) {
    ...
    public Map<Long, ChatReplyMessageVO> loadReplySnapshotsForVisibleMessages(Long userId,
                                                                              Long conversationId,
    ...
    public Set<Long> collectConversationUserIds(List<ChatConversationListItem> items,
    ...
    public List<Long> collectReplyMessageIds(Collection<ChatMessageHistoryItem> items) {
        if (items == null || items.isEmpty()) {
            return List.of();
        }
        return items.stream()
    ...
    public List<Long> activeUserIds(Collection<ChatConversationMember> members) {
    ...
    public String buildMessagePayloadJson(ChatFilePayloadVO filePayload, ChatReplyMessageVO replySnapshot) {
    ...
    public ChatFilePayloadVO buildFilePayload(FileBusinessInfo chatReference, FileInfo fileInfo, String messageType) {
    ...
    public String buildFileMessageSummary(String messageType, FileInfo fileInfo) {
    ...
    public int resolveConversationSpeakRequiredLevel(ChatConversation conversation) {
    ...
    public String metricResultOf(RuntimeException ex) {
        return ex instanceof com.cybzacg.blogbackend.exception.BusinessException ? "business_error" : "system_error";
    }

    // ========== Inner Records ==========

    public record ConversationAccessContext(ChatConversation conversation,
    ...
    public record PreparedFileMessage(Long sourceBusinessId, FileInfo fileInfo) {
    }
