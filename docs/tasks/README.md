...
| 文件                                                                                             | 主题                                  | 当前状态                                        | 优先级 |
| ------------------------------------------------------------------------------------------------ | ------------------------------------- | ----------------------------------------------- | ------ |
| [01-forum-module-todo.md](01-forum-module-todo.md)                                               | 论坛正式模块                          | P1 联动与通知已完成，后台版块测试已补强         | P0     |
...
- 论坛后台版块测试已补强：后台版块分页、详情、新增、修改、状态、删除空版块、有帖子删除失败服务级测试和 `content:forum:*` 权限测试已完成。
