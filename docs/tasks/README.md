...
| 文件 | 对应需求 | 当前状态 | 优先级 |
| --- | --- | --- | --- |
| [01-author-level-permission-todo.md](01-author-level-permission-todo.md) | 作者申请、用户等级、超级管理员安全 | 业务功能已完成，待测试回补 | P0 |
| [02-blog-content-lifecycle-todo.md](02-blog-content-lifecycle-todo.md) | 文章状态、可见范围、审核、系列文章 | 业务功能已完成，待测试回补 | P0 |
| [03-chat-community-todo.md](03-chat-community-todo.md) | 大厅频道、主题频道、群聊增强、论坛挂接 | 业务功能已完成，待测试回补 | P0 |
